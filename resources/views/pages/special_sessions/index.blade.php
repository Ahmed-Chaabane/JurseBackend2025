        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('specialsession.create') }}" class="btn btn-primary">Add New</a>
                </div>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="#">Special Sessions</a></div>
                    <div class="breadcrumb-item">All Special Sessions</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('specialsession.index') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href='{{ route('specialsession.edit', $specialsession->id) }}'
                                                           class="btn btn-sm btn-info btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a>

                                                        <form action="{{ route('specialsession.destroy', $specialsession->id) }}"
                                                              method="POST"
                                                              class="ml-2">
                                ...
                                <div class="float-right">
                                    {{ $specialsessions->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
